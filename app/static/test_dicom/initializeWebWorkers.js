...
if (UrlExists('/static/test_dicom/cornerstoneWADOImageLoaderWebWorker.min.js')) {
  webWorkerUrl = '/static/test_dicom/cornerstoneWADOImageLoaderWebWorker.min.js';
}

if (UrlExists('/static/test_dicom/cornerstoneWADOImageLoaderCodecs.js')) {
  codecsUrl = '/static/test_dicom/cornerstoneWADOImageLoaderCodecs.js';
}
